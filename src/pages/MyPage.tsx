      ...
      <form className="auth-form" onSubmit={save}>
        ...
        <div className="consent-box">
          ...
          <details className="privacy-notice">
            ...
            <ul>
              <li><b>수집 항목</b>: 이름, 학년, 희망학과·계열, (선택) 연락처, 과목 평균 등급(전과목·국수영사과한·국수영사·국수영과)</li>
              <li><b>이용 목적</b>: 대입 전략 결과 개인화, 마이페이지 제공, 교과전형 상담 및 현황 관리</li>
              <li><b>보관·파기</b>: 회원 탈퇴 또는 삭제 요청 시 즉시 파기</li>
              <li><b>최소수집</b>: 미성년자 이용을 고려해 필요한 최소 정보만 수집합니다. 과목별 원점수(개별 등급)는 저장하지 않고, 전략 도구 이용 시 산출된 조합 평균만 저장합니다.</li>
